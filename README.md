...
Acceso al servidor vía SSH con usuario 

root
 o con privilegios sudo.
...
Configurar las Variables de Entorno (.env): Crea el archivo 
...
Crear el Servicio de Systemd (Para que el backend nunca se apague):
bash
...
Ve a la Consola de Credenciales de Google Cloud.
Edita tus credenciales de OAuth 2.0.
